"""
Phase 4 Week 13: Admin Analytics API Routes
REST endpoints for admin dashboard analytics and statistics

Endpoints:
  Protected (require admin auth):
    - GET /api/admin-management/analytics/dashboard - Complete dashboard summary
    - GET /api/admin-management/analytics/admins - Admin count and activity
    - GET /api/admin-management/analytics/moderation - Moderation statistics
    - GET /api/admin-management/analytics/access - Access control statistics
    - GET /api/admin-management/analytics/sessions - Session statistics
    - GET /api/admin-management/analytics/content - Content creation statistics
    - GET /api/admin-management/analytics/history - Historical data for charts

All endpoints require valid admin token (any role can view analytics)
...
from admin.admin_management import require_admin_token, require_admin_role
