...
- [ ] Tests can run: `pytest server/tests/`
...
- [ ] devices/esp8266/docs/README.md documents ESP8266 ✅
- [ ] devices/zima/bbs/README.md documents Zima ✅
...
- [ ] server/src/main.py is entry point ✅
- [ ] server/src/server.py creates Flask app ✅
- [ ] Chat and board modules have routes ✅
- [ ] Tests exist in server/tests/ directory ✅
- [ ] GitHub Actions workflow configured ✅

## Release Standards

- [ ] Stable tags use `vMAJOR.MINOR.PATCH` format (example: `v1.4.2`)
- [ ] Unstable tags use prerelease suffixes (example: `v1.5.0-rc.1`)
- [ ] `VERSIONING.md` updated if release policy changes
- [ ] `CHANGELOG.md` updated before tagging
- [ ] Tag pushed and GitHub Release generated by workflow
